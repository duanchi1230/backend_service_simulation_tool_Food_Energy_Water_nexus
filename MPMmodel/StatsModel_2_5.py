...
def projection(data_test,data_pred,Rpath,writeOut,out):
    ...
    try:
        ...
        # print(pred_matrix_p, pred_matrix_r)
        ...
        for i in varlist:
            ...
            X=data[['y_cotton','y_corn','y_barley','y_durum','y_alfalfa','p_cotton','p_corn','p_barley','p_durum','p_alfalfa','temp','precipitation']]
            X=np.asarray(X)
            #Code for fm logit
            mod = sm.Logit(Y, X)
            res=mod.fit(cov_type='HC0')
            Xtest=data_test[['y_cotton','y_corn','y_barley','y_durum','y_alfalfa','p_cotton','p_corn','p_barley','p_durum','p_alfalfa','temp','precipitation']]

            Xtest=np.asarray(Xtest)
            ytest=res.predict(Xtest)
            Xpred=data_pred[['y_cotton','y_corn','y_barley','y_durum','y_alfalfa','p_cotton','p_corn','p_barley','p_durum','p_alfalfa','temp','precipitation']]
        ...
        if(writeOut):
            try:
                ...
                print('Error writing the output file', NameError)
        else:
          print('No outputs written to file')

    except NameError:
        print("Error in the Projection function", NameError)
# =======================================================
#
#========================
def readTestCSV(pathFID):
 ...
 try:
  ...
  print("Script failed to read in the test CSV file", NameError)
#===================================================
#
#============================
def readProjCSV(pathFID):
 ...
 try:
  ...
  print("Script failed to read in the projection CSV file", NameError)
#===========================================================
#
#
# ===============================================
def Main(pathT,pathP,Rpath,writeOut,out):
 ...
 try:
  ...
  print('Errors- Program did not finish', NameError)
#================================================
#
#
# ============================================================
...
#   to FALSE
# """
# pathTfile='../MPMmodel/Averagefinal_interpreter.csv'
# pathPfile='../MPMmodel/FuturedataN_interpreter.csv'
# out='../MPMmodel/outPuts_test1.csv'
# #
# """
