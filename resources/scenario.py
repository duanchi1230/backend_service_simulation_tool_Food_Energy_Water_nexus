...
class Run_Sceanrios(Resource):
	...
	def post(self, scenario):
		...
		weap_flow, leap_data, s_variables, loaded_group_index = run_scenarios.run_all_secanrios(scenarios, sustainability_variables, loaded_group_index)
		# print(weap_flow, leap_data)
		return {"weap-flow": weap_flow, "leap-data": leap_data, "sustainability_variables": s_variables, "loaded_index_group": loaded_group_index}, 201
